...
function acceptPwd(){
	...
	setTimeout(function(){
		...
		pwdMsg.textContent = 'Password accepted for user ' + myName + '. Public key displayed by clicking the checkbox below';
...
function updateUsers(){
	...
	lock64 = changeBase(GroupKeys[myName],base36,base64);		//add active user to encrypt array
	while (lock64.length < 43) lock64 = 'A' + lock64;
	locksSelected.push(nacl.util.decodeBase64(lock64))
